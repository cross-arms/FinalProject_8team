...
public class FeedService {
     ...
     */
    public List<FeedDto.FeedResponse> getHomeFeeds(Long userId) {
        if (userId != null) {
     ...
     */
    public List<FeedDto.FeedResponse> getPopularFeeds() {
     ...
     */
    public List<FeedDto.FeedResponse> getQuestionFeeds() {
