package com.techit.withus.web.feeds.dto;
...
import static com.techit.withus.web.feeds.domain.entity.FeedType.QUESTION;
...
public class FeedDto {
    ...
    @ToString
    @NoArgsConstructor
    public static class RetrieveFeedResponse {
